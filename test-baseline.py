...
def parse_args():
    ...
    parser.add_argument('--dinov2-weights', type=str, default="../pretrained_model/IFA/dinov2_vitb14_reg4_pretrain.pth")
...
def main():
    ...
    if args.dataset == 'deepglobe':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/models/deepglobe/ifa/resnet50_1shot_avg_50.44.pth'
            if args.shot == 5:
                checkpoint_path = './trained_models/deepglobe/esnet50_5shot_avg_58.76.pth'
    if args.dataset == 'isic':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = 'resnet50_1shot_avg_66.34.pth'
            if args.shot == 5:
    ...
    if args.dataset == 'fss':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/models/fss/ifa/resnet50_1shot_avg_80.27.pth'
            if args.shot == 5:
