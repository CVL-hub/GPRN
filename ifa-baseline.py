...
def main():
    ...
    if args.dataset == 'deepglobe':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/models/deepglobe/resnet50_1shot_avg_51.03.pth'
            if args.shot == 5:
                checkpoint_path = './outdir/models/deepglobe/resnet50_5shot_avg_52.78.pth'
    if args.dataset == 'isic':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/models/isic/resnet50_1shot_avg_56.09.pth'
            if args.shot == 5:
                checkpoint_path = './outdir/models/isic/resnet50_5shot_avg_62.60.pth'
    if args.dataset == 'lung':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/models/lung/resnet50_1shot_avg_74.35.pth'
            if args.shot == 5:
                checkpoint_path = './outdir/models/lung/resnet50_5shot_avg_73.07.pth'
    if args.dataset == 'fss':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/models/fss/resnet50_1shot_avg_77.37.pth'
            if args.shot == 5:
